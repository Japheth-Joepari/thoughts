                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="pt-3 pb-4">
                            <div class="input-group">
                                <form class="form-control d-flex" style="border:none; background: transparent;" action="/search">
                                	@csrf
                                    <input class="form-control " type="search" placeholder=" Search and press enter ..." name="query" 
					...
					<div class="sidebar mt-4">
						...
						<div class="widget rounded">
							...
							<div class="widget-content">
								...
								<span class="newsletter-privacy text-center mt-3">By signing up, you agree to our <a href="personal.html#">Privacy Policy</a></span>
							</div>		
						</div>
