        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <div class="flex items-center justify-center mt-8">
                <a class="flex items-center " href="/dashboard">
                    <img src="{{ asset('/images/logo4.png') }}" alt="" srcset="" style="height: 7rem">
                </a>
            </div>
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                    href="{{ route('trashed.index') }}">


                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" class="bi bi-trash"
                        viewBox="0 0 16 16">
                        <path
                    ...
                    <span class="mx-3">Trash</span>
                </a>
            </nav>
        </div>
        <div class="flex-1 flex flex-col overflow-hidden w-full">
            <header class="flex justify-between items-center py-4 px-6 bg-gray-900 border-b-4 border-indigo-600">
                <div class="flex items-center">
                    ...
                    <div class="relative mx-4 lg:mx-0 w-full">
                        ...
                        <form action="{{ route('search') }}" method="get">
                            <input class="form-input w-3/4 sm:w-64 rounded-md pl-10 pr-4 focus:border-indigo-600"
                                type="text" placeholder="Search" name="query" required
                ...
                <div class="flex items-center">
                    <div class="relative">
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <button type="submit" class="flex mx-4 text-white focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    class="text-white h-6 3-6" stroke="currentColor" stroke-width="2"
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        <button @click="dropdownOpen = ! dropdownOpen"
                            class="relative block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none border border-gray-500">

                            @if (Auth::user()->profile_photo == null)
                                <img class="h-full w-full object-cover" src="{{ asset('/images/avartar.png') }}"
