...
$(document).ready(function () {
    ...
    var $header = $(
        ...
        $clone = $header.before($header.addClass("clone"));
...
$(function () {
    ...
    $(".vertical-menu2 li i.switch").on("click", function () {
        var $submenu = $(this).next(".submenu");
        $submenu.slideToggle(300);
        $submenu.parent().toggleClass("openmenu");
    });
    ...
    /*=========================================================================
            Canvas Menu Image
    =========================================================================*/
    $("button.burger-menu2").on("click", function () {
        $(".canvas-menu2").toggleClass("open");
        $(".main-overlay").toggleClass("active");
    });

    $(".canvas-menu2 .btn-close, .main-overlay").on("click", function () {
        $(".canvas-menu2").removeClass("open");
        $(".main-overlay").removeClass("active");
    });
